...
var SimplePanelExample = React.createClass({displayName: "SimplePanelExample",

    render: function(){
        return(
            React.createElement(Panel, {theme: "chemical"}, 
                React.createElement(Tab, {title: "One", icon: "fa fa-plane"}, 
                    React.createElement(Content, null, "Content of One")
                ), 
                React.createElement(Tab, {title: "Two", icon: "fa fa-fire"}, 
...
ReactDOM.render(
    React.createElement(SimplePanelExample, null),
