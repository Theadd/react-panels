        ...
        return (
          ...
          React.createElement(ToggleButton, {title: "Toggle Toolbar", active: this.state.toolbars, onChange: this.handleToggleToolbars}, 
            React.createElement("i", {className: "fa fa-wrench"})
                ...
                React.createElement(Tab, {title: "One", icon: "fa fa-plane", showToolbar: this.state.toolbars}, 
                    React.createElement(Toolbar, null, "Toolbar content of One"), 
                    React.createElement(Content, null, "Content of One"), 
                    React.createElement(Footer, null, "Footer content of One")
                ), 
                React.createElement(Tab, {title: "Two", icon: "fa fa-fire", showToolbar: this.state.toolbars}, 
                    React.createElement(Content, null, "Content of Two")
                )
            )
        );
    }
